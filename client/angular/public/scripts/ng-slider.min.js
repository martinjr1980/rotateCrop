    ...
    a.module("ngSlider").factory("sliderPointer", ["sliderDraggable", "sliderUtils",
        function(b, c) {
            ...
            return d.prototype = new b, d.prototype.oninit = function(b, c, d, e) {
                ...
                var c = this._getPageCoords(b);
                this._set(this.calc(this.vertical ? c.y : c.x)), this.settings.realtime && this.settings.cb && a.isFunction(this.settings.cb) && this.allowed && this.settings.cb.call(this.parent, this.parent.getValue())
            }, d.prototype.onmouseup = function() {
                this.settings.cb && a.isFunction(this.settings.cb) && this.allowed && this.settings.cb.call(this.parent, this.parent.getValue()), this.is.drag || this.ptr.removeClass("jslider-pointer-hover")
